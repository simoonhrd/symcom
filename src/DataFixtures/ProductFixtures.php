...
class ProductFixtures extends Fixture
{
    ...
    {   
        ...
        // $faker nous permettera de générer des fausses données plus réalistes. => se référer à la doc: https://fakerphp.github.io/
      ...
      for($j = 0; $j <= 4; $j++) {  
            ...
            for($i = 1; $i <= mt_rand(3, 20); $i++){
                ...
                //On insère dans chaque champs de la table product (en base de donnée) les valeurs du produit grâce aux setteurs.
                $product->setTitle($faker->sentence())
                        ->setContent($faker->realText($faker->numberBetween(10, 20))
                        )
                        ->setPrice(mt_rand(15, 35)) // mt_rand(fonction php qui permet de générer un nombre au hasard, en fonctions des paramètres qu'on lui a donné (15, 35))
